  ...
  const responses: Array<Record<string, unknown>> = [
    {
      ...
      webShareUrl: 'https://proof.com/d/test-slug?token=viewer-access-token',
    },
    {
      success: true,
      role: 'commenter',
      token: 'commenter-legacy-token',
      webShareUrl: 'https://proof.com/d/test-slug?token=commenter-legacy-token',
    },
    {
      success: true,
      role: 'editor',
      webShareUrl: 'https://proof.com/d/test-slug?token=missing-token',
    },
  ];
